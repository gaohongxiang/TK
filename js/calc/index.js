...
(function () {
  ...
  const DEFAULTS = {
    ...
    discounts: [0.35, 0.38, 0.40, 0.42, 0.45, 0.48, 0.50], creatorRate: 0,
    ...
    feeNew: 10, creatorRateNew: 0, rateNew: 23.5, discountsNew: [0.35, 0.38, 0.40, 0.42, 0.45, 0.48, 0.50],
  ...
  const els = {
    ...
    creatorRate: $('creatorRate'), creatorRateNew: $('creatorRateNew'), creatorRateReview: $('creatorRateReview'),
    ...
    salePrice: $('salePrice'), saleNet: $('saleNet'), saleCommission: $('saleCommission'), saleCommissionReview: $('saleCommissionReview'), saleProfit: $('saleProfit'), saleMargin: $('saleMargin'),
