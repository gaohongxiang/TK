  ...
  const searchMarkup = includeSearch ? `
      <div class="ot-table-toolbar-left">
        <label class="ot-table-search">
          ...
          <input id="${prefix}-table-search-input" type="text" placeholder=" " value="${escapeHtml(searchQuery)}" autocomplete="off">
          <span class="ot-table-search-hint">${escapeHtml(searchHint)}</span>
        </label>
      </div>` : '';
